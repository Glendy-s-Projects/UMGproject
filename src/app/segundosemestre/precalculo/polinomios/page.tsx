...
const QuadraticSolver = () => {
  ...
  return (
    <AppLayout title="Segundo Semestre" activeTopicId="2">
      <div className="min-h-screen flex flex-col px-6 py-2 gap-0 bg-background text-foreground">
        ...
        <div className="flex flex-col  w-full items-center justify-center text-center">
          ...
          <div className="flex flex-row items-center gap-2">
            <label>
              ...
              <input
                type="number"
                className="border border-outline-variant bg-surface-container-lowest text-on-surface p-1 rounded w-20 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
                value={a}
            ...
            <BotonUtil
              ...
              className="px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors shadow rounded text-xs"
        ...
        <div className="flex flex-wrap justify-center w-full gap-2">
          ...
          <div className="flex flex-col items-center justify-center w-auto ">
            ...
            <div className="border border-outline-variant bg-surface-container-lowest rounded-md p-2 w-full">
              <BlockMath math={paso1} />
          ...
          {/* Gráfica */}
          <div className="w-full h-auto border border-outline-variant bg-surface-container-lowest rounded-md p-2 ">

    ...
    <AppLayout title="Segundo Semestre" activeTopicId="2">
      <div className="flex flex-col gap-2 min-h-screen bg-background text-foreground p-4">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <div className="flex flex-col w-auto">
              ...
              <select
                ...
                className="border border-outline-variant bg-surface-container-lowest text-on-surface rounded-md p-1 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
              >
        ...
        <div className="flex flex-wrap  justify-center gap-4">
          <div className="flex flex-col w-auto border-r border-outline-variant pr-4 ">
            <strong>a) Amplitud</strong>
            <InlineMath math={`|a| = |${aStr}| = ${amplitude2}`} />
          </div>

          <div className="flex flex-col items-center justify-center gap-2 w-auto border-r border-outline-variant pr-4">
        ...
        <div className="flex flex-col items-center justify-center mt-6">
          ...
          <p className="mt-4 text-sm text-muted-foreground text-center">
            ...
            Desfase ≈{" "}
            {Number.isNaN(desfaseNumeric) ? "—" : desfaseNumeric.toFixed(6)}{" "}
            rad.
          </p>
        </div>
      </div>

                ...
                <div className="mb-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    <select
                      value={tiempoUnit}
                      onChange={(e) =>
                        setTiempoUnit(e.target.value as TimeUnit)
                      }
                      className="p-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                    >
              ...
              <div className="mb-6 grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    value={graphUnit}
                    onChange={(e) =>
                      setGraphUnit(e.target.value as DistanceUnit)
                    }
                ...
                <div>
                  ...
                  <select
                    value={graphTimeUnit}
                    onChange={(e) =>
                      setGraphTimeUnit(e.target.value as TimeUnit)
                    }
                    className="w-full p-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                  >
                    <option value="s">s</option>
